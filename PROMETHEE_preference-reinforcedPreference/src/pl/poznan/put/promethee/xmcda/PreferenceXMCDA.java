...
public class PreferenceXMCDA {
	...
	private static Map<String, InputFile> initFiles() {
		...
		files.put("reinforcementFactors", new InputFile("criteriaValues", "criteriaValues", "reinforcement_factors.xml",
				"reinforcement_factors.xml", true));
		files.put("generalisedCriteria", new InputFile("criteriaValues", "criteriaValues", "generalised_criteria.xml",
				"generalised_criteria.xml", false));
		files.put("profilesPerformanceTable", new InputFile("performanceTable", "performanceTable",
				"profiles_performance_table.xml", "profiles_performance_table.xml", false));
		files.put("preferenceThresholds", new InputFile("criteriaThresholds", "criteriaThresholds", "criteria.xml",
				"criteria_thresholds.xml", false));
		return files;
	}
