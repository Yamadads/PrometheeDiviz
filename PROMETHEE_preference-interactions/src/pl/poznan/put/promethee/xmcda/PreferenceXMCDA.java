...
public class PreferenceXMCDA {
	...
	private static Map<String, InputFile> initFiles() {
		...
		files.put("interactions", new InputFile("criteriaValues", "criteriaSetsValues", "interactions.xml", "interactions.xml", true));
		files.put("criterisSets", new InputFile("", "criteriaSets", "","criteria_sets.xml", true));
		return files;
	}
